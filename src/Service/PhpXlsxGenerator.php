...
const N_DATE = 14;
    const N_TIME = 20; // numFmts
    const N_RUB = 164;
        const N_DOLLAR = 165; // cellXfs
    const N_EURO = 166;
const N_DATETIME = 22;
        const F_NORMAL = 0; // shared strings
    const F_HYPERLINK = 1;
    const F_BOLD = 2;
    const F_ITALIC = 4;
    const F_UNDERLINE = 8;
...
const FL_NONE = 0;
const FL_SOLID = 1;
const FL_MEDIUM_GRAY = 2;
const FL_DARK_GRAY = 4;
const FL_LIGHT_GRAY = 8;
const FL_GRAY_125 = 16;
        const FL_COLOR = 32; // General
        const A_DEFAULT = 0; // 0
        const A_LEFT = 1; // 0.00
        const A_RIGHT = 2; // 0%
        const A_CENTER = 4; // 0.00%
        const A_TOP = 8; // mm-dd-yy
        const A_MIDDLE = 16; // h:mm
    const A_BOTTOM = 32;
    const A_WRAPTEXT = 64;
    const B_NONE = 0;
        const B_THIN = 1; // m/d/yy h:mm
    const B_MEDIUM = 2;
    const B_DASHED = 3;
    const B_DOTTED = 4;
    const B_THICK = 5;
    ...
    const B_MEDIUM_DASHED = 8;
        const B_DASH_DOT = 9; // none
        const B_MEDIUM_DASH_DOT = 10; // solid
        const B_DASH_DOT_DOT = 11; // mediumGray
        const B_MEDIUM_DASH_DOT_DOT = 12; // darkGray
        const B_SLANT_DASH_DOT = 13; // lightGray
        public $curSheet; // gray125
...
{TYPES}
    ...
    public static function fromArray(array $rows, $sheetName = null): self
    {
