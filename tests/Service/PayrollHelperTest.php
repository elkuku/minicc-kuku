...
final class PayrollHelperTest extends TestCase
{
    public function testGetDataReturnsCorrectFactDateAndPrevDate(): void
    {
        ...
        $this->assertSame('2024-5-1', $result['factDate']);
        $this->assertSame('2024-4-01', $result['prevDate']);
    }
    ...
    public function testGetDataJanuaryWrapsToPreviousYearDecember(): void
    {
        ...
        $this->assertSame('2024-1-1', $result['factDate']);
        $this->assertSame('2023-12-01', $result['prevDate']);
    }
    ...
    public function testGetDataReturnsAllStoresWhenNoFilter(): void
    {
        ...
        $this->assertArrayHasKey(1, $result['storeData']);
        $this->assertArrayHasKey(2, $result['storeData']);
    }
    ...
    public function testGetDataFiltersStoreById(): void
    {
        ...
        $this->assertSame($store2, $result['stores'][0]);
        $this->assertArrayHasKey(2, $result['storeData']);
        $this->assertArrayNotHasKey(1, $result['storeData']);
    }
    ...
    public function testGetDataStoreDataContainsSaldoIniAndTransactions(): void
    {
        ...
        $this->assertEqualsWithDelta(500.0, $result['storeData'][10]['saldoIni'], PHP_FLOAT_EPSILON);
        $this->assertSame([100.0, 200.0], $result['storeData'][10]['transactions']);
    }
    ...
    public function testGetDataDecemberPrevDateIsNovember(): void
    {
        ...
        $this->assertSame('2024-12-1', $result['factDate']);
        $this->assertSame('2024-11-01', $result['prevDate']);
    }
    ...
    public function testGetDataWithEmptyStores(): void
    {
        ...
        $this->assertEmpty($result['storeData']);
    }
    ...
    public function testGetDataFebruaryPrevDateIsJanuary(): void
    {
        ...
        $this->assertSame('2024-2-1', $result['factDate']);
        $this->assertSame('2024-1-01', $result['prevDate']);
    }
